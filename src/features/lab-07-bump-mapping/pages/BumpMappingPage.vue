...
} from 'src/shared/resources/shaders/bump-mapping/phong/vertex-shader';
import {
  fragmentShaderSource as phongFragmentShaderSource
} from 'src/shared/resources/shaders/bump-mapping/phong/fragment-shader';
...
import { useBumpMappingScene } from 'src/features/lab-07-bump-mapping/hooks/use-bump-mapping-scene';
...
const setupAnimation = async () => {
  ...
  setKeyboardListener(cubeRotate);
